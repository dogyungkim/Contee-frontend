...
const HeroSection = () => {
  return (
    <section className="bg-sky-wash relative overflow-hidden border-b border-border">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="max-w-4xl text-center">
          <div className="text-caption-upper text-muted-foreground">Contee for worship teams</div>
          <h1 className="mt-5 text-4xl font-semibold tracking-normal text-foreground sm:mt-6 sm:text-6xl lg:text-[64px] lg:leading-[1.05]">
            찬양팀 준비를 위한
            <br />
            더 조용하고 정확한 워크스페이스.
          </h1>
        ...
        <div className="mt-10 w-full max-w-5xl sm:mt-14 lg:mt-16">
          <div className="relative mx-auto">
            <div className="surface-card overflow-hidden rounded-2xl border border-[#dcdee0] shadow-[0_20px_50px_rgba(168,200,232,0.18)]">
              <div className="flex items-center justify-between border-b border-border px-5 py-3">
                ...
                <span className="hidden text-caption text-muted-foreground sm:inline">contee.app/workspace</span>
              </div>
              <div className="grid gap-0 lg:grid-cols-[1.25fr_0.75fr]">
                <div className="bg-white p-4 sm:p-6 lg:p-8">
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <h2 className="mt-3 text-xl font-semibold tracking-normal sm:text-2xl">6월 셋째 주일 2부</h2>
                      <p className="mt-2 text-sm text-muted-foreground">
                        Opening prayer · 말씀 전 · 헌금 · 파송
                      </p>
                    </div>
                    <div className="shrink-0 rounded-full bg-black px-3 py-1 text-[11px] font-medium text-white">
                      Live
                    </div>
                  </div>
                  <div className="mt-6 space-y-3 sm:mt-8">
                    {[
                      ...
                      <div key={title} className="flex items-center justify-between gap-3 rounded-xl border border-border bg-[#fafafa] px-3 py-3 sm:px-4 sm:py-4">
                        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                          <div className="shrink-0 text-caption text-muted-foreground">{index}</div>
                          <div className="min-w-0">
                            <div className="truncate text-sm font-medium text-foreground">{title}</div>
                            <div className="mt-1 truncate text-sm text-muted-foreground">{meta}</div>
                          </div>
                        </div>
                        <div className="shrink-0 rounded-md bg-white px-2.5 py-1 text-caption text-foreground ring-1 ring-border">
                          Ready
                        </div>
                      </div>
                    ))}
                ...
                <div className="surface-dark flex flex-col justify-between p-4 sm:p-6 lg:p-8">
                  <div>
                    <div className="text-caption-upper text-white/70">Preview</div>
                    <div className="mt-4 overflow-hidden rounded-xl border border-white/10 bg-[#1a1a1a] p-4">
